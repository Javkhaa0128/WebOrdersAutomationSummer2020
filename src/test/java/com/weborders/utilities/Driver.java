...
public class Driver {
    ...
    ///if reference variables doesn't point on any object it will have a null value
    // whenever we type new Class() - we create a new object
    // reference type can be class, parent class, or interface impelemented by class or parent class
